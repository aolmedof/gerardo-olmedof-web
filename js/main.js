    ...
    certs: [
      {
        ...
        badge: 'img/badges/psm-i.svg',
        type: 'official',
        certId: '597284',
        url: 'https://www.scrum.org/certificates/597284',
        period: 'Nov 2020',
      },
    ],
  },
...
const skillDotRatings = [
  { name: 'AWS',            dots: 5 },
  { name: 'Cloud Computing',dots: 5 },
  { name: 'Scrum',          dots: 5 },
  { name: 'Agile',          dots: 5 },
  { name: 'S3',             dots: 5 },
  { name: 'Terraform',      dots: 4 },
  { name: 'CloudFormation', dots: 4 },
  { name: 'Linux',          dots: 4 },
  { name: 'Jenkins',        dots: 4 },
  { name: 'CI/CD',          dots: 4 },
  { name: 'DynamoDB',       dots: 4 },
  { name: 'CloudWatch',     dots: 4 },
  { name: 'Lambda',         dots: 4 },
  { name: 'Qlik',           dots: 4 },
  { name: 'Talend',         dots: 4 },
  { name: 'Bash',           dots: 4 },
  { name: 'SQL',            dots: 4 },
  { name: 'Networking',     dots: 4 },
  { name: 'Jira/Confluence',dots: 4 },
  { name: 'Docker',         dots: 3 },
  { name: 'ServiceNow',     dots: 3 },
  { name: 'Python',         dots: 3 },
  { name: 'Oracle',         dots: 3 },
  { name: 'GCP',            dots: 3 },
];
...
const aiPlaceholders = {
  en: [
    'How many years of AWS experience does Gerardo have?',
    'What certifications does Gerardo hold?',
    "Tell me about Gerardo's DevOps experience",
    'What cloud platforms has Gerardo worked with?',
    'What data tools does Gerardo use?',
  ],
  es: [
    '¿Cuántos años de experiencia tiene Gerardo en AWS?',
    '¿Qué certificaciones tiene Gerardo?',
    'Cuéntame sobre la experiencia DevOps de Gerardo',
    '¿Con qué plataformas cloud ha trabajado Gerardo?',
    '¿Qué herramientas de datos usa Gerardo?',
  ],
};
...
const quickBtnData = {
  years: {
    en: { q: 'How many years of experience does Gerardo have?', label: 'Years of experience?' },
    es: { q: '¿Cuántos años de experiencia tiene Gerardo?',     label: '¿Años de experiencia?' },
  },
  certs: {
    en: { q: 'What certifications does Gerardo have?', label: 'Certifications' },
    es: { q: '¿Qué certificaciones tiene Gerardo?',    label: 'Certificaciones' },
  },
  stack: {
  ...
  visa: {
    en: { q: 'Where is Gerardo based?',                    label: 'Location & remote' },
    es: { q: '¿Dónde está basado Gerardo?',                label: 'Ubicación y remoto' },
  },
};
...
function renderCertifications(t) {
  ...
  const typeLabel = {
    ...
    expired:       { cls: 'cert-type-expired',       icon: 'fa-solid fa-clock-rotate-left',    label: t.certifications.type_expired },
  };
